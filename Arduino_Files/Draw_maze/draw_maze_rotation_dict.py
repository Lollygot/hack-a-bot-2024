...
if __name__ == "__main__":
    test_data = [
        ...
        # bottom side
        # ([950, 970, 930, 980, 960], (2, 0), 30),
        # ([950, 970, 930, 980, 960], (2, 1), 30),
        # ([950, 970, 930, 980, 960], (2, 2), 30),
        # ([950, 970, 930, 980, 960], (2, 3), 30),
        # ([950, 970, 930, 980, 960], (2, 4), 30),

        # ([950, 950, 930, 950, 950], (3, 4), 0),

        # # left side
        ([950, 950, 950, 950, 930], (0, 2), 0),
        ([950, 950, 950, 950, 930], (1, 2), 0),
        ([950, 950, 950, 950, 930], (2, 2), 0),
